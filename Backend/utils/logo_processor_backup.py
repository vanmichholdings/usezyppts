...
from utils.celery_worker import celery_app, run_logo_task, run_vector_task, run_social_task, run_ultra_fast_task
import pickle
import hashlib
...
class LogoProcessor:
    ...
    def _create_transparent_png(self, image_path):
        ...
        try:
            ...
            # Use optimized background removal
            if self.ultra_fast_mode:
                # Use faster background removal algorithm
                img = self._smart_background_removal_fast(img)
            else:
