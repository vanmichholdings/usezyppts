...
class Config:
    ...
    BACKEND_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))  # Go up from backups to Backend
    INSTANCE_DIR = os.path.join(BACKEND_DIR, 'instance')
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL', f'sqlite:///{os.path.join(INSTANCE_DIR, "app.db")}')
